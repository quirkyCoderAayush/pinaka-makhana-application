        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-2xl font-black text-white">PINAKA</h3>
                <p className="text-xs text-gray-300 -mt-1 tracking-widest">FOODS</p>
              </div>
            </div>
            <p className="text-gray-300 leading-relaxed">
              Premium Makhana sourced directly from nature's heartlands. 
              Experience the authentic goodness of this ancient superfood, 
          ...
          {/* Customer Care */}
          <div className="space-y-6">
            <h4 className="text-xl font-bold text-white">Customer Care</h4>
            <ul className="space-y-3">
              ...
              <li><Link to="/track" className="text-gray-300 hover:text-white transition-colors">Track Your Order</Link></li>
              <li><Link to="/bulk-orders" className="text-gray-300 hover:text-white transition-colors">Bulk Orders</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300">Megapolis Sparklet,</p>
                  <p className="text-gray-300">Pune, India 411057</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">+91 9110904320</p>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <p className="text-gray-300">anupamakashyap@pinaka.com</p>
              </div>
            </div>
            
            {/* Newsletter */}
            <div className="space-y-3">
              <h5 className="font-semibold text-white">Subscribe to Newsletter</h5>
              <div className="flex">
                <input 
                  type="email" 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
            ...
            <div className="flex items-center space-x-3 text-gray-300">
              ...
              <div>
                ...
                <p className="text-sm">On Orders Above ₹500</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 text-gray-300">
              ...
              <div>
                ...
                <p className="text-sm">SSL Protected</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 text-gray-300">
        ...
        <div className="container mx-auto px-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © 2024 Pinaka Foods. All rights reserved. Made with ❤️ for healthy snacking.
            </div>
